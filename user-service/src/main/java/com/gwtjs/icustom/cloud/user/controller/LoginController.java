package com.gwtjs.icustom.cloud.user.controller;
...
import com.gwtjs.icustom.cloud.user.model.ResultStatusVO;
import com.gwtjs.icustom.cloud.user.model.ResultFactory;
...
public class LoginController {
	...
	@ResponseBody
	public ResultStatusVO login(@Valid @RequestBody UserVO loginInfoVo, BindingResult bindingResult) {
